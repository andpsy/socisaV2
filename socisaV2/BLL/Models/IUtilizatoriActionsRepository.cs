...
namespace SOCISA.Models
{
    ...
    public class UtilizatoriActionsRepository : IUtilizatoriActionsRepository
    {
        ...
        public response CountAll()
        {
            try
            {
                DataAccess da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_ACTIONSsp_count");
        ...
        public response Update(int id, string fieldValueCollection)
        {
            ...
            UtilizatorAction item = (UtilizatorAction)(Find(id).Result);
        ...
        public response Update(string fieldValueCollection)
        {
            ...
            return ((UtilizatorAction)(Find(Convert.ToInt32(tmpItem.ID)).Result)).Update(fieldValueCollection);
        }
        ...
        public response Delete(int _id)
        {
            ...
            return ((UtilizatorAction)obj.Result).Delete();
        }
