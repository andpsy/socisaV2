...
{
    public interface IProceseStadiiRepository
    {
        ...
        response Insert(ProcesStadiu item);
        response Update(ProcesStadiu item);
        response Update(int id, string fieldValueCollection);
        response Update(string fieldValueCollection);

        response Delete(ProcesStadiu item);
        response HasChildrens(ProcesStadiu item, string tableName);
        response HasChildren(ProcesStadiu item, string tableName, int childrenId);
        response GetChildrens(ProcesStadiu item, string tableName);
        response GetChildren(ProcesStadiu item, string tableName, int childrenId);
    ...
    public class ProceseStadiiRepository : IProceseStadiiRepository
    {
        private string connectionString;
        private int authenticatedUserId;

        public ProceseStadiiRepository(int _authenticatedUserId, string _connectionString)
        {
        ...
        public response CountAll()
        {
            try
            {
                DataAccess da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "PROCESE_STADIIp_count");
        ...
        public response HasChildrens(ProcesStadiu item, string tableName)
        {
            return item.HasChildrens(tableName);
        }

        public response HasChildren(ProcesStadiu item, string tableName, int childrenId)
        {
        ...
        public response Delete(int _id)
        {
            ...
            //return JsonConvert.DeserializeObject<ProcesStadiu>(obj.Message).Delete();
            return ((ProcesStadiu)obj.Result).Delete();
        }

        public response HasChildrens(int _id, string tableName)
        {
            var obj = Find(_id);
            //return JsonConvert.DeserializeObject<ProcesStadiu>(obj.Message).HasChildrens(tableName);
            return ((ProcesStadiu)obj.Result).HasChildrens(tableName);
        }
        public response HasChildren(int _id, string tableName, int childrenId)
        {
            var obj = Find(_id);
            //return JsonConvert.DeserializeObject<ProcesStadiu>(obj.Message).HasChildren(tableName, childrenId);
            return ((ProcesStadiu)obj.Result).HasChildren(tableName, childrenId);
        }
        public response GetChildrens(int _id, string tableName)
        {
            var obj = Find(_id);
            //return JsonConvert.DeserializeObject<ProcesStadiu>(obj.Message).GetChildrens(tableName);
            return ((ProcesStadiu)obj.Result).GetChildrens(tableName);
        }
        public response GetChildren(int _id, string tableName, int childrenId)
        {
            var obj = Find(_id);
            //return JsonConvert.DeserializeObject<ProcesStadiu>(obj.Message).GetChildren(tableName, childrenId);
            return ((ProcesStadiu)obj.Result).GetChildren(tableName, childrenId);
        }
    }
}
