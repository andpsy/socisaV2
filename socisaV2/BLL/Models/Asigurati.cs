...
namespace SOCISA.Models
{
    ...
    {
        const string _TABLE_NAME = "asigurati";
        ...
        [Required(ErrorMessageResourceName = "emptyDenumireAsigurat", ErrorMessageResourceType = typeof(socisaV2.Resources.ErrorMessagesResx))]
        ...
        public response Delete()
        {
            ...
            DataAccess da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "ASIGURATIsp_soft_delete", _parameters.ToArray());
        ...
        public response Validare()
        {
            ...
            if (!succes) // daca nu s-au putut citi validarile din fisier, sau nu sunt definite in fisier, mergem pe varianta hardcodata
            {
                ...
                if (this.DENUMIRE == null || this.DENUMIRE.Trim() == "")
                {
                    ...
                    err = ErrorParser.ErrorMessage("emptyDenumireAsigurat");
