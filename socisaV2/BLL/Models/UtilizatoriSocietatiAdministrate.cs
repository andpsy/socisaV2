...
{
    public class UtilizatorSocietateAdministrata
    {
        const string _TABLE_NAME = "utilizatori_societati_administrate";
        ...
        public UtilizatorSocietateAdministrata() { }

        public UtilizatorSocietateAdministrata(int _authenticatedUserId, string _connectionString)
        {
            authenticatedUserId = _authenticatedUserId;
            connectionString = _connectionString;
        }

        public UtilizatorSocietateAdministrata(int _authenticatedUserId, string _connectionString, int _ID)
        {
            authenticatedUserId = _authenticatedUserId;
            connectionString = _connectionString;
            DataAccess da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATI_ADMINISTRATEsp_GetById", new object[] { new MySqlParameter("_ID", _ID) });
            MySqlDataReader r = da.ExecuteSelectQuery();
            while (r.Read())
            {
                IDataRecord item = (IDataRecord)r;
                UtilizatorSocietateAdministrataConstructor(item);
                break;
            }
            r.Close(); r.Dispose(); da.CloseConnection();
        }

        public UtilizatorSocietateAdministrata(int _authenticatedUserId, string _connectionString, IDataRecord item)
        {
            authenticatedUserId = _authenticatedUserId;
            connectionString = _connectionString;
            UtilizatorSocietateAdministrataConstructor(item);
        ...
        public void UtilizatorSocietateAdministrataConstructor(IDataRecord item)
        {
            try { this.ID = Convert.ToInt32(item["ID"]); }
            catch { }
            try { this.ID_UTILIZATOR = Convert.ToInt32(item["ID_UTILIZATOR"]); }
            catch { }
            try { this.ID_SOCIETATE = Convert.ToInt32(item["ID_SOCIETATE"]); }
            catch { }
        }
        ...
        public response Insert()
        {
            ...
            var col = CommonFunctions.table_columns(authenticatedUserId, connectionString, "utilizatori_societati_administrate");
            ...
            DataAccess da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATI_ADMINISTRATEsp_insert", _parameters.ToArray());
        ...
        public response Update()
        {
            ...
            DataAccess da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATI_ADMINISTRATEsp_update", _parameters.ToArray());
        ...
        public response Delete()
        {
            ...
            {
                _parameters.Add(new MySqlParameter("_ID", this.ID));
                da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATI_ADMINISTRATEsp_soft_delete", _parameters.ToArray());
            }
            else
            {
                _parameters.Add(new MySqlParameter("_ID_UTILIZATOR", this.ID_UTILIZATOR));
                _parameters.Add(new MySqlParameter("_ID_SOCIETATE", this.ID_SOCIETATE));
                da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATI_ADMINISTRATEsp_soft_deleteByFields", _parameters.ToArray());
            }
        ...
        {
            return CommonFunctions.HasChildrens(authenticatedUserId, connectionString, this, "utilizatori_societati_administrate", tableName);
        }

        public response HasChildren(string tableName, int childrenId)
        {
            return CommonFunctions.HasChildren(authenticatedUserId, connectionString, this, "utilizatori_societati_administrate", tableName, childrenId);
        }
