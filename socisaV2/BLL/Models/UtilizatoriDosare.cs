...
{
    public class UtilizatorDosar
    {
        const string _TABLE_NAME = "utilizatori_dosare";
        ...
        public UtilizatorDosar() { }

        public UtilizatorDosar(int _authenticatedUserId, string _connectionString)
        {
            authenticatedUserId = _authenticatedUserId;
            connectionString = _connectionString;
        }

        public UtilizatorDosar(int _authenticatedUserId, string _connectionString, int _ID)
        {
            authenticatedUserId = _authenticatedUserId;
            connectionString = _connectionString;
        ...
        public void UtilizatorDosarConstructor(IDataRecord item)
        {
        ...
        public response Insert()
        {
            ...
            var col = CommonFunctions.table_columns(authenticatedUserId, connectionString, "utilizatori_dosare");
            ...
            DataAccess da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_DOSAREsp_insert", _parameters.ToArray());
        ...
        public response Update()
        {
            ...
            DataAccess da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_DOSAREsp_update", _parameters.ToArray());
        ...
        public response Delete()
        {
            ...
            {
                _parameters.Add(new MySqlParameter("_ID", this.ID));
                da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_DOSAREsp_soft_delete", _parameters.ToArray());
            }
            else
            {
        ...
        {
            return CommonFunctions.HasChildrens(authenticatedUserId, connectionString, this, "utilizatori_dosare", tableName);
        }

        public response HasChildren(string tableName, int childrenId)
        {
            return CommonFunctions.HasChildren(authenticatedUserId, connectionString, this, "utilizatori_dosare", tableName, childrenId);
        }
