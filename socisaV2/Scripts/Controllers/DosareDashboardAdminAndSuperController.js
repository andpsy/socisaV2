...
function ($scope, $http, $filter, $rootScope, $window) {
    ...
    $rootScope.$watch('ID_DOSAR', function (newValue, oldValue) {
        if (newValue != null && newValue != undefined && $rootScope.activeTab.Value == 'utilizatori') {
    ...
    $scope.getUtilizatoriAsignati = function () {
        EnableDisableInputs('#dosareDashboardAdminAndSuperMainDiv', spinner, ACTIVE_DIV_ID, true, true);
        $http.post('/UtilizatoriDosare/GetUtilizatoriAsignati', { 'id_dosar': $rootScope.ID_DOSAR })
            .then(function (response) {
                ...
                //spinner.stop();
                EnableDisableInputs('#dosareDashboardAdminAndSuperMainDiv', spinner, ACTIVE_DIV_ID, false, true);
            }, function (response) {
                //spinner.stop();
                EnableDisableInputs('#dosareDashboardAdminAndSuperMainDiv', spinner, ACTIVE_DIV_ID, false, true);
