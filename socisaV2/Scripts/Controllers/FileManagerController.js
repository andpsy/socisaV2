        ...
        $http.get('/FileManager/GetOrphanFiles')
            .then(function (response) {
                if (response != 'null' && response != null && response.data != null) {
                    ...
                    $scope.deAfisat = 0;
                    document.getElementById("butonStergereFisiereOrfane").value = document.getElementById("butonStergereFisiereOrfane").value + " (" + $scope.OrphanFiles.length + ")";
